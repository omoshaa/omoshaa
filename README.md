...
![Learning](https://skillicons.dev/icons?i=spring,nodejs,react,nextjs)
...
```mermaid
graph TD
    A["🪖 Exército Brasileiro<br/>Infraestrutura de TI na prática"] --> B["🎓 COTUCA UNICAMP<br/>Técnico em Dev. de Sistemas"]
    B --> C["📚 Estudo ativo<br/>Spring Boot, APIs, Arquitetura"]
    C --> D["🚀 Projetos práticos<br/>Construindo o portfólio"]
    D --> E["💼 Primeira oportunidade<br/>Estágio em Dev"]
```
